...
const Footer = memo(() => {
  return (
    <footer className="relative z-10 bg-[rgba(10,10,10,0.5)] overflow-hidden pb-0 pt-20 lg:pb-0 lg:pt-[100px]">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-between gap-8 lg:gap-0">
          ...
          <div className="w-full lg:w-1/3 mb-6 lg:mb-0 text-center">
            ...
            <p className="flex items-center justify-center text-xs sm:text-sm font-medium text-gray-400 sm:text-muted">
      ...
      {/* Decorative Elements */}
      <div>
        <span className="absolute -bottom-10 left-0 z-[-1] opacity-30 pointer-events-none">
          <svg
            width={160}
            height={160}
            viewBox="0 0 217 229"
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stopColor="#e50914" stopOpacity="0.08" />
                <stop offset={1} stopColor="#C4C4C4" stopOpacity={0} />
              </linearGradient>
            </defs>
          </svg>
        </span>
        <span className="absolute right-10 top-6 z-[-1] opacity-30 pointer-events-none">
          <svg
            width={48}
            height={48}
            viewBox="0 0 75 75"
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#e50914" stopOpacity="0.31" />
                <stop offset={1} stopColor="#C4C4C4" stopOpacity={0} />
              </linearGradient>
            </defs>
          </svg>
...
const LinkGroup = ({ children, header }: { children: React.ReactNode; header: string }) => {
  return (
    <div className="w-full text-center">
      <h4 className="mb-4 sm:mb-6 text-base sm:text-lg font-semibold text-gray-300 sm:text-white">
        {header}
      </h4>
...
const NavLink = ({ link, label }: { link: string; label: string }) => {
  return (
    <li>
      <a
        href={link}
        className="inline-block text-sm sm:text-base leading-loose text-gray-400 sm:text-gray-200 transition-colors hover:text-primary"
      >
        {label}
      </a>
    </li>
