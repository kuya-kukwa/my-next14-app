...
/**
 * SocialButton - Consistent button for social authentication
 * Supports Google, Facebook, Apple, and GitHub
 */
  ...
  ({ provider, children, className, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        <span className="font-semibold">{children || config.label}</span>
      </button>
    );
  }
);
